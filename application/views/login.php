                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image text-center">
                                <img src="<?php echo base_url();?>/assets/img/logo.png" class="img-fluid mt-5" style="width: 90%!important;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?>
                                    <form class="user" action="<?php echo base_url();?>index.php/UsuariosController/login" method="post">
